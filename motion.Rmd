...
Now that "RStudio" is running and the session is set up, we can begin the tutorial.
...
A browser window should open and and, if you accept Adobe Player, a motion chart showing the population size by country should pop up. You can hover over any country and see its population size. 
