...
The function "gregexpr" tells us if a pattern is present in a text and if so where the pattern begins and how long it is.
...
> 
> 1. How many words does the exercise text consist of?
